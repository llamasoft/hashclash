...
uint32 bf_simplify(uint32 a, uint32 b, uint32 c) { return 0; }
booleanfunction SHA1_F1_data(sha1_f1, "SHA1_F1"), SHA1_F2_data(sha1_f2, "SHA1_F2"), SHA1_F3_data(sha1_f3, "SHA1_F3"),
    SHA1_F4_data(sha1_f4, "SHA1_F4"), BF_simplify(bf_simplify, "BF_simplify");
...
double deep_analysis_path(const sha1differentialpath &sha1path, const uint32 dQt[80], unsigned tbegin, unsigned tend) { return 0; }
