...
inline void start_update_counter(uint64 &performancecounter) { performancecounter -= cpu_timestamp(); }
inline void end_update_counter(uint64 &performancecounter) { performancecounter += cpu_timestamp(); }
...
class update_performance_counter {
  ...
  public:
    ...
    ~update_performance_counter() { _counter += cpu_timestamp(); }
};
