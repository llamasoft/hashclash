...
void sha1_connect_thread::connectbits_01234(
    const pair<connect_bitdata, unsigned> &in2,
    map<connect_bitdata, unsigned> &out,
    unsigned b,
    const sha1differentialpath &lower,
    const sha1differentialpath &upper,
    vector<pair<byteconditions, byteconditions>> &newconds,
    vector<connect_bitdata> &outdata,
    vector<unsigned> &outmincond
) {
    ...
    */
    ...
    for (unsigned dqtm1 = 0; dqtm1 <= dQtm1bit; ++dqtm1) {
        ...
        if (b0 == 1 && result.dQtm1 != dQtm1b2b31) {
            continue;
        }
        if (b0 == 26 && result.dQtm1 != dQtm1b27b31) {
            continue;
        }
        if (b0 == 31 && (Qtm1b == Qtm1b31not || Qtm1b == Qtm1b31not2)) {
            continue;
        }
        if (b0 == 31) {
        ...
        for (unsigned bfo0index = 0; bfo0index < bfo0.size(); ++bfo0index) {
            ...
            for (unsigned mmt = 0; mmt <= mmtbit; ++mmt) {
                ...
                if ((Qtm1freemask & (1 << b0)) && bfc0.first != bc_constant) {
                    continue;
                }
                if ((Qtm2freemask & (1 << ((b0 + 2) & 31))) && bfc0.second != bc_constant) {
                    continue;
                }
                if ((Qtm3freemask & (1 << ((b0 + 2) & 31))) && bfc0.third != bc_constant) {
                    continue;
                }
                ...
                for (unsigned dqt = 0; dqt <= dQtbit; ++dqt) {
                    ...
                    if (b1 == 1 && result.dQt != dQtb2b31) {
                        continue;
                    }
                    if (b1 == 26 && result.dQt != dQtb27b31) {
                        continue;
                    }
                    if (b1 == 31 && (Qtb == Qtb31not || Qtb == Qtb31not2)) {
                        continue;
                    }
                    if (b1 == 31) {
                    ...
                    for (unsigned bfo1index = 0; bfo1index < bfo1.size(); ++bfo1index) {
                        ...
                        for (unsigned mmtp1 = 0; mmtp1 <= mmtp1bit; ++mmtp1) {
                            ...
                            if ((Qtfreemask & (1 << b1)) && bfc1.first != bc_constant) {
                                continue;
                            }
                            if ((Qtm1freemask & (1 << b0)) && bfc1.second != bc_constant) {
                                continue;
                            }
                            if ((Qtm2freemask & (1 << b0)) && bfc1.third != bc_constant) {
                                continue;
                            }
                            ...
                            if (steps == 2) {
                                if (storefdata) {
                                    result.fqt[b1] = bfc1.first;
                                }

                                if (storenewconds) {
                                    newcond.first.set(
                                        bc_constant, bc_constant, bc_constant, bc_constant, bc_constant, bfc1.third, bfc0.third
                                    );
                                    newcond.second.set(
                                        bc_constant, bc_constant, bc_constant, connect_helper(mmtp1, mmtp1bit), connect_helper(mmt, mmtbit)
                                    );
                                    newconds.push_back(newcond);
                                    outdata.push_back(result);
                                    unsigned curcond =
                                        in2.second + (bfc0.third == bc_constant ? 0 : 1) + (bfc1.third == bc_constant ? 0 : 1);
                                    outmincond.push_back(curcond);
                                } else {
                                    if (compmincond) {
                                        unsigned curcond =
                            ...
                            for (unsigned dqtp1 = 0; dqtp1 <= dQtp1bit; ++dqtp1) {
                                ...
                                if (b2 == 1 && result.dQtp1 != dQtp1b2b31) {
                                    continue;
                                }
                                if (b2 == 26 && result.dQtp1 != dQtp1b27b31) {
                                    continue;
                                }
                                if (b2 == 31 && (Qtp1b == Qtp1b31not || Qtp1b == Qtp1b31not2)) {
                                    continue;
                                }
                                if (b2 == 31) {
                                ...
                                for (unsigned bfo2index = 0; bfo2index < bfo2.size(); ++bfo2index) {
                                    ...
                                    for (unsigned mmtp2 = 0; mmtp2 <= mmtp2bit; ++mmtp2) {
                                        ...
                                        if ((Qtp1freemask & (1 << b2)) && bfc2.first != bc_constant) {
                                            continue;
                                        }
                                        if ((Qtfreemask & (1 << b1)) && bfc2.second != bc_constant) {
                                            continue;
                                        }
                                        if ((Qtm1freemask & (1 << b1)) && bfc2.third != bc_constant) {
                                            continue;
                                        }
                                        ...
                                        if (steps == 3) {
                                            if (storefdata) {
                                                result.fqtp1[b2] = bfc2.first;
                                            }
                                            if (storenewconds) {
                                                newcond.first.set(
                                                    bc_constant, bc_constant, bc_constant, bc_constant, bfc2.third, bfc1.third, bfc0.third
                                                );
                                                newcond.second.set(
                                                    bc_constant,
                                                    bc_constant,
                                                    connect_helper(mmtp2, mmtp2bit),
                                                    connect_helper(mmtp1, mmtp1bit),
                                                    connect_helper(mmt, mmtbit)
                                                );
                                                newconds.push_back(newcond);
                                                outdata.push_back(result);
                                                unsigned curcond = in2.second + (bfc0.third == bc_constant ? 0 : 1) +
                                                                   (bfc1.third == bc_constant ? 0 : 1) +
                                                                   (bfc2.third == bc_constant ? 0 : 1);
                                                outmincond.push_back(curcond);
                                            } else {
                                                if (compmincond) {
                                                    unsigned curcond = in2.second + (bfc0.third == bc_constant ? 0 : 1) +
                                        ...
                                        for (unsigned bfo3index = 0; bfo3index < bfo3.size(); ++bfo3index) {
                                            ...
                                            for (unsigned mmtp3 = 0; mmtp3 <= mmtp3bit; ++mmtp3) {
                                                ...
                                                if ((Qtp2freemask & (1 << b3)) && bfc3.first != bc_constant) {
                                                    continue;
                                                }
                                                if ((Qtp1freemask & (1 << b2)) && bfc3.second != bc_constant) {
                                                    continue;
                                                }
                                                if ((Qtfreemask & (1 << b2)) && bfc3.third != bc_constant) {
                                                    continue;
                                                }
                                                ...
                                                for (unsigned bfo4index = 0; bfo4index < bfo4.size(); ++bfo4index) {
                                                    ...
                                                    for (unsigned mmtp4 = 0; mmtp4 <= mmtp4bit; ++mmtp4) {
                                                        ...
                                                        if (result.dFtp4 & (1 << b4)) {
                                                            continue;
                                                        }
                                                        if (b4 == 31) {
                                                            bfc4 = msb_bf_forwardconditions(
                                                                *Ftp4, Qtp3b, bfc3.first, in.rqtp1[1], bfo4[bfo4index]
                                                            );
                                                        } else {
                                                            bfc4 = Ftp4->forwardconditions(Qtp3b, bfc3.first, in.rqtp1[1], bfo4[bfo4index]);
                                                        }
                                                        if ((Qtp3freemask & (1 << b4)) && bfc4.first != bc_constant) {
                                                            continue;
                                                        }
                                                        if ((Qtp2freemask & (1 << b3)) && bfc4.second != bc_constant) {
                                                            continue;
                                                        }
                                                        if ((Qtp1freemask & (1 << b3)) && bfc4.third != bc_constant) {
                                                            continue;
                                                        }
                                                        ...
                                                        if (storenewconds) {
                                                            ...
                                                            outdata.push_back(result);
                                                            unsigned curcond =
                                                                in2.second + (bfc0.third == bc_constant ? 0 : 1) +
                                                                (bfc1.third == bc_constant ? 0 : 1) + (bfc2.third == bc_constant ? 0 : 1) +
                                                                (bfc3.third == bc_constant ? 0 : 1) + (bfc4.first == bc_constant ? 0 : 1) +
                                                                (bfc4.second == bc_constant ? 0 : 1) + (bfc4.third == bc_constant ? 0 : 1);
                                                            outmincond.push_back(curcond);
                                                        } else {
                                                            if (compmincond) {
                                                                unsigned curcond = in2.second + (bfc0.third == bc_constant ? 0 : 1) +
                                                                                   ...
                                                                                   (bfc2.third == bc_constant ? 0 : 1) +
                                                                                   (bfc3.third == bc_constant ? 0 : 1) +
                                                                                   (bfc4.first == bc_constant ? 0 : 1) +
                                                                                   (bfc4.second == bc_constant ? 0 : 1) +
                                                                                   (bfc4.third == bc_constant ? 0 : 1);
                                                                auto itb = out.insert(make_pair(result, curcond));
                                                                if (!itb.second && curcond < itb.first->second) {
                                                                    itb.first->second = curcond;
                                                                }
...
void sha1_connect_thread::connectbits_1234(
    const pair<connect_bitdata, unsigned> &in2,
    map<connect_bitdata, unsigned> &out,
    unsigned b,
    const sha1differentialpath &lower,
                                ...
                                for (unsigned mmtp3 = 0; mmtp3 <= mmtp3bit; ++mmtp3) {
                                    ...
                                    for (unsigned bfo4index = 0; bfo4index < bfo4.size(); ++bfo4index) {
                                        ...
                                        for (unsigned mmtp4 = 0; mmtp4 <= mmtp4bit; ++mmtp4) {
                                            ...
                                            CHECK_TUNNEL_BITCONDITION(Ttp2b, bfc4.second);
                                            CHECK_TUNNEL_BITCONDITION(Ttp3b, bfc4.first);
                                            unsigned curcond = in2.second + (bfc1.third == bc_constant ? 0 : 1) +
                                                               (bfc2.third == bc_constant ? 0 : 1) + (bfc3.third == bc_constant ? 0 : 1) +
                                                               (bfc4.first == bc_constant ? 0 : 1) + (bfc4.second == bc_constant ? 0 : 1) +
                                                               (bfc4.third == bc_constant ? 0 : 1);
                                            if (storenewconds) {
...
template <bool storenewconds>
void sha1_connect_thread::connectbits_234(
    const pair<connect_bitdata, unsigned> &in2,
    map<connect_bitdata, unsigned> &out,
    unsigned b,
    const sha1differentialpath &lower,
                        ...
                        for (unsigned bfo4index = 0; bfo4index < bfo4.size(); ++bfo4index) {
                            ...
                            for (unsigned mmtp4 = 0; mmtp4 <= mmtp4bit; ++mmtp4) {
                                ...
                                if (storenewconds) {
                                    ...
                                    newcond.second.set(
                                        connect_helper(mmtp4, mmtp4bit), connect_helper(mmtp3, mmtp3bit), connect_helper(mmtp2, mmtp2bit)
                                    );
                                    newconds.push_back(newcond);
                                    outdata.push_back(result);
                                    outmincond.push_back(curcond);
...
template <bool storenewconds>
void sha1_connect_thread::connectbits_34(
    const pair<connect_bitdata, unsigned> &in2,
    map<connect_bitdata, unsigned> &out,
    unsigned b,
    const sha1differentialpath &lower,
        ...
        for (unsigned mmtp3 = 0; mmtp3 <= mmtp3bit; ++mmtp3) {
            ...
            for (unsigned bfo4index = 0; bfo4index < bfo4.size(); ++bfo4index) {
                ...
                for (unsigned mmtp4 = 0; mmtp4 <= mmtp4bit; ++mmtp4) {
                    ...
                    CHECK_TUNNEL_BITCONDITION(Ttp2b, bfc4.second);
                    CHECK_TUNNEL_BITCONDITION(Ttp3b, bfc4.first);
                    unsigned curcond = in2.second + (bfc3.third == bc_constant ? 0 : 1) + (bfc4.first == bc_constant ? 0 : 1) +
                                       (bfc4.second == bc_constant ? 0 : 1) + (bfc4.third == bc_constant ? 0 : 1);
                    if (storenewconds) {
...
template <bool storenewconds>
void sha1_connect_thread::connectbits_4(
    const pair<connect_bitdata, unsigned> &in2,
    map<connect_bitdata, unsigned> &out,
    unsigned b,
    const sha1differentialpath &lower,
    ...
    */
    ...
    for (unsigned bfo4index = 0; bfo4index < bfo4.size(); ++bfo4index) {
        ...
        for (unsigned mmtp4 = 0; mmtp4 <= mmtp4bit; ++mmtp4) {
            ...
            CHECK_TUNNEL_BITCONDITION(Ttp2b, bfc4.second);
            CHECK_TUNNEL_BITCONDITION(Ttp3b, bfc4.first);
            unsigned curcond = in2.second + (bfc4.first == bc_constant ? 0 : 1) + (bfc4.second == bc_constant ? 0 : 1) +
                               (bfc4.third == bc_constant ? 0 : 1);
            if (storenewconds) {
...
unsigned sha1_connect_thread::connect_paths(
    const sha1differentialpath &lowerpath,
    const sha1differentialpath &upperpath,
    ...
    */
    ...
    while (b < 32) {
        ...
        if (b < 2) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<1, false, false, false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 4) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<2, false, false, false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 6) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<3, false, false, false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 8) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<4, false, false, false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 32) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<5, false, false, false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else {
    ...
    while (b < 32 + 8) {
        ...
        if (b < 2) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<1, true, false, true>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 4) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<2, true, false, true>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 6) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<3, true, false, true>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 8) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<4, true, false, true>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 32) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_01234<5, true, false, true>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 34) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_1234<false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 36) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_234<false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 38) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                connectbits_34<false>(
                    *it, bitdataresults[b + 1], b, lowerpath, upperpath, bitdatanewcond[b], bitdataend[b], bitdatamincond[b]
                );
            }
        } else if (b < 40) {
    ...
    for (b = 0; b < 40; ++b) {
        ...
        if (b < 2) {
            for (auto it = bitdataresults[b].begin(); it != bitdataresults[b].end(); ++it) {
                ...
                if (bitdatanewcond[b].size() != bitdataend[b].size()) {
                    cerr << "#bitdatanewcond!=#bitdataend @ b=" << b << endl;
                    throw;
                }
        ...
        if (bitdatastart[b].size() != bitdataend[b].size() || bitdataend[b].size() != bitdatanewcond[b].size()) {
            throw;
        }
    }
        ...
        if (bindex[bit] < bitdataend[bit].size()) {
            ...
            if (bit != 0) {
                ...
                for (unsigned k = 0; k < bitdataend[0].size(); ++k) {
                    if (bitdataend[0][k] == bitdatastart[1][bindex[1]]) { // we have a full path !!!
                        if (bcond[0] + bitdatanewcondhw[0][k] + mincond0 > container.bestpathcond) {
                            continue;
                        }
                        bindex[0] = k;
...
void sha1_connect_thread::sha1_connect(
    const sha1differentialpath &lowerpath, const vector<sha1differentialpath> &upperpaths, path_container &container, unsigned prev_eq_b
) {
    ...
    if (dpFt.size() == 0) {
        ...
        for (unsigned b = 0; b < 32; ++b) {
            if (container.tunnelconditions(t - 3, b) == bc_plus || container.tunnelconditions(t - 3, b) == bc_minus) {
                Qtm3freemask |= 1 << b;
            }
            if (container.tunnelconditions(t - 2, b) == bc_plus || container.tunnelconditions(t - 2, b) == bc_minus) {
                Qtm2freemask |= 1 << b;
            }
            if (container.tunnelconditions(t - 1, b) == bc_plus || container.tunnelconditions(t - 1, b) == bc_minus) {
                Qtm1freemask |= 1 << b;
            }
            if (container.tunnelconditions(t, b) == bc_plus || container.tunnelconditions(t, b) == bc_minus) {
                Qtfreemask |= 1 << b;
            }
            if (container.tunnelconditions(t + 1, b) == bc_plus || container.tunnelconditions(t + 1, b) == bc_minus) {
                Qtp1freemask |= 1 << b;
    ...
    for (unsigned b = 27; b <= 31; ++b) {
        if (lowerpath(t - 1, b) == bc_minus) {
            Qtm1b31not = bc_plus;
        }
        if (lowerpath(t - 1, b) == bc_plus) {
            Qtm1b31not = bc_minus;
        }
        if (lowerpath(t, b) == bc_minus) {
            Qtb31not = bc_plus;
        }
        if (lowerpath(t, b) == bc_plus) {
            Qtb31not = bc_minus;
        }
    }
    if (lowerpath(t - 1, 31) == bc_constant) {
        Qtm1b31not2 = Qtm1b31not;
    }
    if (lowerpath(t, 31) == bc_constant) {
        Qtb31not2 = Qtb31not;
    }
    sdr sdrQtm1 = lowerpath[t - 1].getsdr();
    sdrQtm1.mask &= uint32(0) - uint32(1 << 2);
    sdrQtm1.sign &= sdrQtm1.mask;
    dQtm1b2b31 = sdrQtm1.adddiff();
    sdrQtm1.mask &= uint32(0) - uint32(1 << 27);
    sdrQtm1.sign &= sdrQtm1.mask;
    dQtm1b27b31 = sdrQtm1.adddiff();
    sdr sdrQt = lowerpath[t].getsdr();
    sdrQt.mask &= uint32(0) - uint32(1 << 2);
    sdrQt.sign &= sdrQt.mask;
    dQtb2b31 = sdrQt.adddiff();
    sdrQt.mask &= uint32(0) - uint32(1 << 27);
    sdrQt.sign &= sdrQt.mask;
    ...
    while (i < upperpaths.size()) {
        ...
        for (unsigned b = 27; b <= 31; ++b) {
            if (upperpaths[i](t + 1, b) == bc_minus) {
                Qtp1b31not = bc_plus;
            }
            if (upperpaths[i](t + 1, b) == bc_plus) {
                Qtp1b31not = bc_minus;
            }
        }
        if (upperpaths[i](t + 1, 31) == bc_constant) {
            Qtp1b31not2 = Qtp1b31not;
        }
        sdr sdrQtp1 = upperpaths[i][t + 1].getsdr();
        sdrQtp1.mask &= uint32(0) - uint32(1 << 2);
        sdrQtp1.sign &= sdrQtp1.mask;
        dQtp1b2b31 = sdrQtp1.adddiff();
        sdrQtp1.mask &= uint32(0) - uint32(1 << 27);
        sdrQtp1.sign &= sdrQtp1.mask;
        ...
        if (b < 32 + 8) {
            ...
            while (j < upperpaths.size()) {
                if ((dpFt[i] ^ dpFt[j]) & ftmask) {
                    break;
                }
                if ((dpFtp1[i] ^ dpFtp1[j]) & ftp1mask) {
                    break;
                }
                if ((dQtp1[i] ^ dQtp1[j]) & qtp1mask) {
                    break;
                }
                if ((dpFtp2[i] ^ dpFtp2[j]) & ftp2mask) {
                    break;
                }
                if ((dpFtp3[i] ^ dpFtp3[j]) & ftp3mask) {
                    break;
                }
                if ((dpFtp4[i] ^ dpFtp4[j]) & ftp4mask) {
                    break;
                }
                bool bcok = true;
