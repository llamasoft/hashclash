...
int main(int argc, char **argv) {
    ...
    cout << "Extend MD5 differential paths forward\n"
            "Copyright (C) 2009 Marc Stevens\n"
    ...
    try {
        ...
        po::options_description desc("Allowed options"), msg("Define message differences (as +bitnr and -bitnr, bitnr=1-32)"),
            ihv("Define start IV (necessary for t=0 and t=1)"), all("Allowed options");
        ...
        if (false == container.normalt01 && container.t <= 1) {
            ...
            cout << "dIHV= " << (IHV2[0] - IHV1[0]) << " " << (IHV2[1] - IHV1[1]) << " " << (IHV2[2] - IHV1[2]) << " "
                 << (IHV2[3] - IHV1[3]) << " = 0x" << hex << (IHV2[0] - IHV1[0]) << " " << (IHV2[1] - IHV1[1]) << " " << (IHV2[2] - IHV1[2])
                 << " " << (IHV2[3] - IHV1[3]) << dec << endl;
            cout << "dIHV= " << naf(IHV2[0] - IHV1[0]) << " " << naf(IHV2[1] - IHV1[1]) << " " << naf(IHV2[2] - IHV1[2]) << " "
                 << naf(IHV2[3] - IHV1[3]) << dec << endl;
        }
