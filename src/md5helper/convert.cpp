...
int split(parameters_type &parameters) {
    ...
    for (unsigned i = 0; i < parameters.split; ++i) {
        ...
        start = iend;
        string filename =
            parameters.infile1 + "_" + boost::lexical_cast<string>(i) + "of" + boost::lexical_cast<string>(parameters.split) + ".bin.gz";
...
void reconstructpath(const uint32 ihv1[], const uint32 ihv2[], const uint32 msg1[], const uint32 msg2[], ofstream &o) {
