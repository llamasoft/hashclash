    ...
    for (int t = -2; t < 64; ++t) {
        ...
        case 14:
            if ((Qvalue[offset + t] ^ (Q[offset + t] & Qvaluemask[offset + t]) ^ (Qprev[offset + t] & Q[offset + t - 1])) &
                ~(Q14m6Q3m5tunnel | Q14Q3m14tunnel)) {
                if (t < badt) {
                    badt = t;
                }
            }
        ...
        case 8:
            if (Qvalue[offset + t] !=
                ((Q[offset + t] & Qvaluemask[offset + t] & ~Q8Q12m15tunnel) ^ (Qprev[offset + t] & Q[offset + t - 1]))) {
                if (t < badt) {
                    badt = t;
                }
            }
        ...
        case 12:
            if (Qvalue[offset + t] !=
                ((Q[offset + t] & Qvaluemask[offset + t] & rotate_left(~Q8Q12m15tunnel, 22)) ^ (Qprev[offset + t] & Q[offset + t - 1]))) {
                if (t < badt) {
                    badt = t;
                }
            }
        ...
        case 4:
            if (Qvalue[offset + t] !=
                ((Q[offset + t] & Qvaluemask[offset + t] & ~Q4m4tunnel & ~Q4m5tunnel) ^ (Qprev[offset + t] & Q[offset + t - 1]))) {
                if (t < badt) {
                    badt = t;
                }
            }
        ...
        case 5:
            if (Qvalue[offset + t] != ((Q[offset + t] & Qvaluemask[offset + t] & ~Q5m5tunnel) ^ (Qprev[offset + t] & Q[offset + t - 1]))) {
                if (t < badt) {
                    badt = t;
                }
            }
        ...
        case 9:
            if (Qvalue[offset + t] !=
                ((Q[offset + t] & Qvaluemask[offset + t] & ~Q9m9tunnel & ~Q9m10tunnel) ^ (Qprev[offset + t] & Q[offset + t - 1]))) {
                if (t < badt) {
                    badt = t;
                }
            }
        ...
        case 10:
            if (Qvalue[offset + t] !=
                ((Q[offset + t] & Qvaluemask[offset + t] & ~Q10m10tunnel) ^ (Qprev[offset + t] & Q[offset + t - 1]))) {
                if (t < badt) {
                    badt = t;
                }
            }
...
void collisionfinding_thread::do_step26() {
    ...
    md5compress(ihv2, block2);
    {
        ...
        if (ihv2[1] - ihv[1] != dQ[3] + dQ[offset + 64]) {
            return;
        }
        if (ihv2[2] - ihv[2] != dQ[2] + dQ[offset + 63]) {
            return;
        }
        if (ihv2[3] - ihv[3] != dQ[1] + dQ[offset + 62]) {
            return;
        }
...
void collisionfinding_thread::do_step25() {
    ...
    do {
        ...
        if (Qvalue[offset + 26] != ((Q[offset + 26] & Qvaluemask[offset + 26]) ^ (Qprev[offset + 26] & Q[offset + 25]))) {
            continue;
        }
        TESTCOUNT(17);
        ...
        m[3] = rotate_right(R3, md5_rc[3]) - md5_ff(Q[offset + 3], Q[offset + 2], Q[offset + 1]) - Q[offset + 0] - md5_ac[3];
        ...
        if (Qvalue[offset + 27] != ((Q[offset + 27] & Qvaluemask[offset + 27]) ^ (Qprev[offset + 27] & Q[offset + 26]))) {
            continue;
        }

        uint32 R8 = Q[offset + 9] - Q[offset + 8];
        m[8] = rotate_right(R8, md5_rc[8]) - md5_ff(Q[offset + 8], Q[offset + 7], Q[offset + 6]) - Q[offset + 5] - md5_ac[8];
        ...
        if (Qvalue[offset + 28] != ((Q[offset + 28] & Qvaluemask[offset + 28]) ^ (Qprev[offset + 28] & Q[offset + 27]))) {
            continue;
        }
...
void collisionfinding_thread::do_step24() {
    ...
    do {
        ...
        m[9] = rotate_right(R9, md5_rc[9]) - md5_ff(Q[offset + 9], Q[offset + 8], Q[offset + 7]) - Q[offset + 6] - md5_ac[9];
        ...
        if (Qvalue[offset + 25] != ((Q[offset + 25] & Qvaluemask[offset + 25]) ^ (Qprev[offset + 25] & Q[offset + 24]))) {
            continue;
        }
        TESTCOUNT(14);
...
void collisionfinding_thread::do_step23() {
    ...
    do {
        ...
        m[4] = rotate_right(R4, md5_rc[4]) - md5_ff(Q[offset + 4], Q[offset + 3], Q[offset + 2]) - Q[offset + 1] - md5_ac[4];
        ...
        if (Qvalue[offset + 24] != ((Q[offset + 24] & Qvaluemask[offset + 24]) ^ (Qprev[offset + 24] & Q[offset + 23]))) {
            continue;
        }
        TESTCOUNT(11);
...
void collisionfinding_thread::do_step21() {
    ...
    do {
        ...
        do {
            ...
            if (Qvalue[offset + 22] != ((Q[offset + 22] & Qvaluemask[offset + 22]) ^ (Qprev[offset + 22] & Q[offset + 21]))) {
                continue;
            }
            ...
            do {
                ...
                uint32 T11 = md5_ff(Q[offset + 11], Q[offset + 10], Q[offset + 9]) + Q[offset + 8] + m[11] + md5_ac[11];
                uint32 R11 = rotate_left(T11, md5_rc[11]);
                uint32 Q12 = Q[offset + 11] + R11;
                //				TESTCOUNT(6);
                if (Qvalue[offset + 12] !=
                    ((Q12 & Qvaluemask[offset + 12] & ~rotate_left(Q8tmask, 22)) ^ (Qprev[offset + 12] & Q[offset + 11]))) {
                    continue;
                }
                if (Qvalue[offset + 13] != ((Q[offset + 13] & Qvaluemask[offset + 13]) ^ (Qprev[offset + 13] & Q12))) {
                    continue;
                }
                //				TESTCOUNT(7);
                Q[offset + 12] = Q12;
                uint32 R15 = Q[offset + 16] - Q[offset + 15];
                m[15] =
                    rotate_right(R15, md5_rc[15]) - md5_ff(Q[offset + 15], Q[offset + 14], Q[offset + 13]) - Q[offset + 12] - md5_ac[15];

                // uint32 T22 = md5_gg(Q[offset+22], Q[offset+21], Q[offset+20]) + pT22;
                uint32 T22 = md5_gg(Q[offset + 22], Q[offset + 21], Q[offset + 20]) + Q[offset + 19] + m[15] + md5_ac[22];
                uint32 R22 = rotate_left(T22, md5_rc[22]);
                Q[offset + 23] = Q[offset + 22] + R22;
                if (Qvalue[offset + 23] != ((Q[offset + 23] & Qvaluemask[offset + 23]) ^ (Qprev[offset + 23] & Q[offset + 22]))) {
                    continue;
                }
                //				TESTCOUNT(8);
...
void collisionfinding_thread::do_step18() {
    ...
    uint32 Q8pvalue = Qvalue[offset + 8] ^ (Qprev[offset + 8] & Q[offset + 7]) ^ (xrng128() & Q8pmask);
    Q8pcur = 0;
    do {
        Q8pcur -= 1;
        Q8pcur &= Q8pmask;
        ...
        uint32 Q9value = Qvalue[offset + 9] ^ (Qprev[offset + 9] & Q[offset + 8]) ^ (xrng128() & Q9mask);
        Q9cur = 0;
        do {
            Q9cur -= 1;
            Q9cur &= Q9mask;
            ...
            uint32 Q10value = Qvalue[offset + 10] ^ (Qprev[offset + 10] & Q[offset + 9]) ^ (xrng128() & Q10mask);
            Q10cur = 0;
            do {
                Q10cur -= 1;
                Q10cur &= Q10mask;
                ...
                uint32 Q11value = Qvalue[offset + 11] ^ (Qprev[offset + 11] & Q[offset + 10]) ^ (xrng128() & Q11mask);
                Q11cur = 0;
                do {
                    Q11cur -= 1;
                    Q11cur &= Q11mask;
                    ...
                    uint32 pT11 = md5_ff(Q[offset + 11], Q[offset + 10], Q[offset + 9]) + md5_ac[11];

                    uint32 Q12value = Qvalue[offset + 12] ^ (Qprev[offset + 12] & Q[offset + 11]) ^
                                      (Qprev[offset + 13] & (Q[offset + 13] ^ Qvalue[offset + 13])) ^ (xrng128() & Q12mask);
                    Q12cur = 0;
                    do {
                        Q12cur -= 1;
                        Q12cur &= Q12mask;
        ...
        do {
            ...
            do {
                ...
                do {
                    ...
                    uint32 pT6 = md5_ff(Q[offset + 6], Q[offset + 5], Q[offset + 4]) + Q[offset + 3] + md5_ac[6];
                    ...
                    uint32 badmask = Qvalue[offset + 18] ^ ((testQ18 & Qvaluemask[offset + 18]) ^ (Qprev[offset + 18] & Q[offset + 17]));
                    ...
                    do {
                        ...
                        if (Qvalue[offset + 18] != ((Q[offset + 18] & Qvaluemask[offset + 18]) ^ (Qprev[offset + 18] & Q[offset + 17]))) {
                            continue;
                        }
    ...
    while (true) {
        ...
        for (unsigned k = 0; k < 128; ++k) {
            ...
            do {
                ...
                uint32 m0 = rotate_right(Q1 - Q[offset + 0], md5_rc[0]) - md5_ff(Q[offset + 0], Q[offset - 1], Q[offset - 2]) -
                            Q[offset - 3] - md5_ac[0];
...
void collisionfinding_thread::filltables() {
    ...
    if (1) {
        for (unsigned b = 0; b < 32; ++b) {
            ...
            if (Q3b == bc_constant && Q14b == bc_constant && (Q4b == bc_constant || Q4b == bc_zero || Q4b == bc_plus) &&
    ...
    for (unsigned b = 0; b < 32; ++b) {
        ...
        if (Q8b == bc_constant && Q12b == bc_constant && Q9b != bc_prev && Q9b != bc_prevn && Q13b != bc_prev && Q13b != bc_prevn &&
    ...
    // Q14m6Q3m5 tunnel
    for (unsigned b = 0; b < 32; ++b) {
        bitcondition Q14b = diffpath(14, b), Q3b = diffpath(3, b), Q15b = diffpath(15, b), Q16b = diffpath(16, b), Q4b = diffpath(4, b);
    ...
    for (unsigned b = 0; b < 32; ++b) {
        ...
        if ((Q4b == bc_constant) && (Q5b == bc_constant || Q5b == bc_zero || Q5b == bc_plus) &&
            ...
            diffpath.setbitcondition(4, b, bc_zero);
            Q4m4tunnel |= 1 << b;
        } else if ((Q4b == bc_constant) && (Q5b == bc_constant || Q5b == bc_one || Q5b == bc_minus) &&
            ...
            diffpath.setbitcondition(4, b, bc_zero);
            Q4m5tunnel |= 1 << b;
        } else if ((Q5b == bc_constant) && (Q6b == bc_constant || Q6b == bc_zero || Q6b == bc_plus)) {
            if (Q6b == bc_constant) {
    ...
    for (unsigned b = 0; b < 32; ++b) {
        ...
        if ((Q9b == bc_constant) && (Q10b == bc_constant || Q10b == bc_zero || Q10b == bc_plus) &&
            ...
            Q9m9tunnel |= 1 << b;
        } else if ((Q9b == bc_constant) && (Q10b == bc_constant || Q10b == bc_one || Q10b == bc_minus) &&
            ...
            diffpath.setbitcondition(9, b, bc_zero);
            Q9m10tunnel |= 1 << b;
        } else if ((Q10b == bc_constant) && (Q11b == bc_constant || Q11b == bc_zero || Q11b == bc_plus)) {
            if (Q11b == bc_constant) {
    ...
    for (int t = diffpath.tbegin(); t < diffpath.tend(); ++t) {
        ...
        Qvaluemask[offset + t] = (~diffpath[t].set0()) | diffpath[t].set1() | diffpath[t].prev() | diffpath[t].prevn() |
