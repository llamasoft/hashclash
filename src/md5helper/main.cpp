...
int main(int argc, char **argv) {
    ...
    cout << "MD5 differential path toolbox\n"
            "Copyright (C) 2009 Marc Stevens\n"
    ...
    try {
        ...
        msg
            .add_options()("diffm0", po::value<vector<int>>(&msgdiff[0]), "delta m0")("diffm1", po::value<vector<int>>(&msgdiff[1]), "delta m1")("diffm2", po::value<vector<int>>(&msgdiff[2]), "delta m2")("diffm3", po::value<vector<int>>(&msgdiff[3]), "delta m3")("diffm4", po::value<vector<int>>(&msgdiff[4]), "delta m4")("diffm5", po::value<vector<int>>(&msgdiff[5]), "delta m5")("diffm6", po::value<vector<int>>(&msgdiff[6]), "delta m6")("diffm7", po::value<vector<int>>(&msgdiff[7]), "delta m7")("diffm8", po::value<vector<int>>(&msgdiff[8]), "delta m8")("diffm9", po::value<vector<int>>(&msgdiff[9]), "delta m9")("diffm10", po::value<vector<int>>(&msgdiff[10]), "delta m10")("diffm11", po::value<vector<int>>(&msgdiff[11]), "delta m11")("diffm12", po::value<vector<int>>(&msgdiff[12]), "delta m12")("diffm13", po::value<vector<int>>(&msgdiff[13]), "delta m13")("diffm14", po::value<vector<int>>(&msgdiff[14]), "delta m14")(
        ...
        if (vm.count("help") || 0 == vm.count("startnearcollision") + vm.count("upperpaths") + vm.count("enhancepath") +
                                         vm.count("findcollision") + vm.count("convert") + vm.count("split") + vm.count("join") +
                                         vm.count("combinepaths") + vm.count("negatepaths") + vm.count("pathfromtext") +
                                         vm.count("pathfromcollision") + vm.count("startpartialpathfromfile")) {
            cout << cmds << desc << endl;
            return 0;
        }
